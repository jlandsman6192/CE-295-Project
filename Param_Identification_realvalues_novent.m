...
%   Term Project
%   Calculations of real parameter values with no ventilation
%   Prof. Moura

%   This script will calculate estimates of the real parameters of the
%   materials and simulate the dynamical equations.

%   Param_Identification_realvalues_novent.m
